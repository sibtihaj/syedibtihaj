  ...
  return (
    <div className="flex flex-col items-center gap-4 text-center mb-10">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-xs font-medium bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent uppercase tracking-[0.2em]">Cloud & Platform Engineer | Solutions Architecture</p>
      </div>
    </div>
  );
};
