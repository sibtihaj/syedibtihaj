        ...
        {timeline.map((item, index) => (
          ...
          >
            <div className="hidden md:flex flex-col items-center flex-shrink-0 w-6">
              ...
              <div className="h-full w-px bg-zinc-100 group-last:hidden" />
            </div>

            <div className="flex-1">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
                <div>
                  <h4 className="text-xl md:text-2xl font-normal text-zinc-900 group-hover:text-blue-700 transition-colors">
                    {item.company}
                  </h4>
                ...
                <span className="text-xs md:text-sm font-mono font-normal text-zinc-400 bg-zinc-50 px-3 py-1.5 rounded-lg border border-zinc-100">
                  {item.date}
                </span>
              </div>
                ...
                <div className="p-8 rounded-[22px] bg-white">
                  ...
                  <ul className="space-y-4">
                    {item.responsibilities.map((resp, i) => (
                      <li key={i} className="flex items-start text-sm text-zinc-500 group">
                        ...
                        <span className="group-hover:text-zinc-800 transition-colors">{resp}</span>
                      </li>
                    ))}
                  </ul>
                </div>
